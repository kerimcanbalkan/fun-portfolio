...
import type { AsepriteData, Asset, BitmapFontData, LoadBitmapFontOpt, LoadSpriteOpt, LoadSpriteSrc, ShaderData, SoundData, SpriteAtlasData, SpriteData, Uniform } from "./assets";
import type { FontData } from "./assets/font";
import type { AudioPlay, AudioPlayOpt } from "./audio";
import type { AgentComp, AgentCompOpt, AnchorComp, AnimateComp, AreaComp, AreaCompOpt, AreaEffectorComp, AreaEffectorCompOpt, BodyComp, BodyCompOpt, BuoyancyEffectorComp, BuoyancyEffectorCompOpt, CircleComp, ColorComp, ConstantForceComp, ConstantForceCompOpt, DoubleJumpComp, FixedComp, FollowComp, HealthComp, LayerComp, LifespanCompOpt, MaskComp, NamedComp, NavigationComp, NavigationCompOpt, OffScreenComp, OffScreenCompOpt, OpacityComp, OutlineComp, PatrolComp, PatrolCompOpt, PointEffectorComp, PointEffectorCompOpt, PolygonComp, PolygonCompOpt, PosComp, RectComp, RectCompOpt, RotateComp, ScaleComp, SentryCandidates, SentryComp, SentryCompOpt, ShaderComp, SpriteComp, SpriteCompOpt, StateComp, StayComp, SurfaceEffectorComp, SurfaceEffectorCompOpt, TextComp, TextCompOpt, TextInputComp, TileComp, TileCompOpt, TimerComp, UVQuadComp, ZComp } from "./components/";
import type { EmitterOpt, ParticlesComp, ParticlesOpt } from "./components/draw/particles";
import type { BoomOpt, GameObjEventMap, GameObjEventNames, LevelOpt, SceneDef, SceneName, TupleWithoutFirst } from "./game";
import type { DrawBezierOpt, DrawCircleOpt, DrawCurveOpt, DrawLineOpt, DrawLinesOpt, DrawRectOpt, DrawSpriteOpt, DrawTextOpt, DrawTriangleOpt, FormattedText, FrameBuffer, LineCap, LineJoin, Texture } from "./gfx";
...
export type { KAPLAYCtx as KaboomCtx, KAPLAYOpt as KaboomOpt, KAPLAYPlugin as KaboomPlugin, KEvent as Event, KEventController as EventController, KEventHandler as EventHandler, };
/**

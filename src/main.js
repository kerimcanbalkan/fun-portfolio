...
k.loadSprite("player", "./player.png", {
  ...
  anims: {
    "idle-down": 0,
    "walk-down": { from: 0, to: 4, loop: true, speed: 8 },
    "idle-side": 10,
    "walk-side": { from: 10, to: 14, loop: true, speed: 8 },
    "idle-up": 5,
    "walk-up": { from: 5, to: 9, loop: true, speed: 8 },
  },
});
k.setBackground(k.Color.fromHex("#311514"));
